...
class NativeCache<T> {
    ...
    // Поиск имелся в виду только поиск, а вы намешали в одно и поиск слота, и изменение состояния объекта)
    // Для get, и put, и is_key внутри нужен номер слота под их нужды, вот его надо отыскивать.
