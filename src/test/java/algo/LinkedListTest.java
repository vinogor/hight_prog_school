...
public class LinkedListTest {
    ...
    private static Node1 node_1_10_1;
    private static Node1 node_1_10_2;
    private static Node1 node_1_10_3;
    private static Node1 node_1_11;
    private static Node1 node_1_666;
    ...
    public void setUp() {
        ...
        node_1_10_1 = new Node1(10);
        node_1_10_2 = new Node1(10);
        node_1_10_3 = new Node1(10);
        node_1_11 = new Node1(11);
        node_1_666 = new Node1(666);
    }

    @Test
    public void addInTail_01() {
        ll.addInTail(node_1_3);
        assertThat(ll.toString(), is("3 "));
        assertThat(ll.tail, is(node_1_3));
    }

    @Test
    public void addInTail_02() {
        ll.addInTail(node_1_3);
        ll.addInTail(node_1_10_1);
        assertThat(ll.toString(), is("3 10 "));
        assertThat(ll.tail, is(node_1_10_1));
    }
    ...
    public void addInTail_03() {
        ll.addInTail(node_1_3);
        ll.addInTail(node_1_10_1);
        ll.addInTail(node_1_666);
        assertThat(ll.toString(), is("3 10 666 "));
        assertThat(ll.tail, is(node_1_666));
    }
    ...
    public void remove_02() {
        ...
        assertThat(ll.tail, is(node_1_11));
    }
    ...
    public void findAll_01() {
        ...
        ArrayList<Node1> result = ll.findAll(10);

        assertThat(result.size(), is(1));
        assertThat(result.get(0).value, is(10));
        assertThat(result.get(0).next, is(node_1_11));
    }
    ...
    public void findAll_04() {
        ...
        assertThat(result.get(0).next, is(node_1_10_2));
        assertThat(result.get(1).next, is(node_1_11));
    }
    ...
    public void findAll_05() {
        ...
        assertThat(result.get(0).next, is(node_1_11));
        assertThat(result.get(1).next, is(node_1_666));
    ...
    public void findAll_06() {
        ...
        assertThat(result.get(2).value, is(10));
        assertThat(result.get(0).next, is(node_1_10_2));
        assertThat(result.get(1).next, is(node_1_10_3));
        assertThat(result.get(2).next, nullValue());
    }
    ...
    public void insertAfter_01() {
        ...
        ll.insertAfter(node_1_3, node_1_10_1);
    ...
    public void insertAfter_02() {
        ...
        ll.insertAfter(node_1_666, node_1_10_1);
    ...
    public void insertAfter_03() {
        ...
        ll.insertAfter(null, node_1_10_1);
    ...
    public void insertAfter_04() {
        ...
        ll.insertAfter(node_1_10_3, node_1_11);
    ...
    public void insertAfter_08() {
        ll.insertAfter(null, node_1_11);
        ll.insertAfter(node_1_11, node_1_3);
        ll.insertAfter(null, node_1_10_1);
    ...
    public void insertAfter_09() {
        ll.insertAfter(node_1_3, node_1_11);
        ll.insertAfter(null, node_1_11);
        assertThat(ll.toString(), is("11 "));
        assertThat(ll.tail, is(node_1_11));
    }
    ...
    public void insertAfter_12() {
        ll.addInTail(node_1_3);
        ll.addInTail(node_1_666);
        ll.insertAfter(node_1_666, node_1_11);
